...
<link rel="shortcut icon" href="https://cdn.jsdelivr.net/gh/qishao520/upload/bfq_52meme_top/images/favicon.ico" type="image/x-icon">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/qishao520/upload/bfq_52meme_top/css/aiblog.css">
<style> 
...
.aiblog-full-icon span{background: url(https://cdn.jsdelivr.net/gh/qishao520/upload/bfq_52meme_top/images/full.png) center no-repeat;}
.aiblog-fulloff-icon span{background: url(https://cdn.jsdelivr.net/gh/qishao520/upload/bfq_52meme_top/images/fulloff.webp) center no-repeat;}
...
<script src="https://cdn.jsdelivr.net/gh/qishao520/upload/bfq_52meme_top/js/aiblog.js"></script>
<script src="https://cdn.jsdelivr.net/gh/qishao520/upload/bfq_52meme_top/js/jquery.min.js"></script>
<script src="https://cdn.jsdelivr.net/gh/qishao520/upload/bfq_52meme_top/js/setting.js"></script>

<?php
if(strpos($_GET['url'],'m3u8')){
echo'<script src="https://cdn.jsdelivr.net/gh/qishao520/upload/bfq_52meme_top/js/hls.min.js"></script>';
} elseif(strpos($_GET['url'],'flv')){
echo'<script src="https://cdn.jsdelivr.net/gh/qishao520/upload/bfq_52meme_top/js/flv.min.js"></script>';
}
?>
<script src="https://cdn.jsdelivr.net/gh/qishao520/upload/bfq_52meme_top/js/layer.js"></script>
<script>
